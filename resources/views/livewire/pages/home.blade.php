    ...
    <div class="max-w-2xl py-32 mx-auto sm:py-48 lg:py-56">
        ...
        <div class="text-center">
            <h1 class="text-3xl font-bold tracking-tight text-white sm:text-6xl">
                Guarde para sempre o sentimento por aquela pessoa especial.
            </h1>
            <p class="mt-6 text-lg leading-8 text-gray-300">Expressar o que sentimos torna cada momento mais especial e
                inesquecível.</p>
            <div class="flex items-center justify-center mt-10 gap-x-6">
                <a href="{{ route('web.cards.create') }}"
                    class="rounded-md bg-indigo-500 duration-300 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">
                    Começar agora
                </a>
                <a href="{{ route('web.cards') }}" class="text-sm font-semibold leading-6 text-white">Ver mais<span
